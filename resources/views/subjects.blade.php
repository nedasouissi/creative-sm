                ...
                <div class="modal-body p-0">
                    <div class="card card-plain">
                        <div class="card-header pb-0 text-left">
                            <h3 class="font-weight-bolder text-info text-gradient" id="subjectModalLabel">Add New Subject</h3>
                        </div>
                                    ...
                                    <div class="card mb-4 mx-4">
                                        <div class="card-header pb-0">
                                            <div class="d-flex flex-row justify-content-between">
                                                ...
                                                <a href="#" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#modal-subject" type="button" onclick="openAddSubjectModal()">+&nbsp; New Subject</a>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table align-items-center mb-0">
                                                    ...
                                                    @foreach($subjects as $subject)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ $subject->teachers->pluck('name')->implode(', ') }}</td>
                                                            <td class="text-center">
                                                                <a href="#" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit subject" onclick="openEditSubjectModal({{ $subject->id }})">
                                                                    <i class="fas fa-user-edit text-secondary"></i>
                                                                </a>
                                                                <span onclick="deleteSubject({{ $subject->id }})">
                    <i class="cursor-pointer fas fa-trash text-secondary"></i>
                </span>
                                                                <form id="delete-subject-form-{{ $subject->id }}" action="{{ route('subjects.destroy', $subject->id) }}" method="POST" style="display: none;">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                            </td>
